...
export default function AdminManagement() {
    ...
    const getRoleBadge = (role: string) => {
        ...
        switch (role) {
            ...
            default:
                return (
                    <span className={`${baseClasses} bg-gray-700 text-gray-300 border border-gray-600 flex items-center gap-1`}>
                            ...
                            <form onSubmit={handleCreateAdmin} className="space-y-4">
                                ...
                                <div className="flex gap-2">
                                    <button
                                        type="submit"
                                        disabled={isLoading}
                                        className="bg-[#1e40af] text-white px-4 py-2 rounded-md hover:bg-blue-700 disabled:opacity-50 transition-colors"
                                    >
                                    ...
                                    <button
                                        ...
                                        className="bg-gray-600 text-gray-300 px-4 py-2 rounded-md hover:bg-gray-500 transition-colors"
                                    >
                                        Cancel
                                    </button>
                                </div>
