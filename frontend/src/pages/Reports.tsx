...
import { Download, FileText, BarChart2, TrendingUp, Calendar } from 'lucide-react';
import {
    LineChart,
    Line,
    XAxis,
...
export default function Reports() {
    ...
    return (
        ...
        <main className="max-w-7xl mx-auto py-16 px-4 sm:px-6 lg:px-8">
            ...
            {/* Generate report - i know its not working */}
            <div className="mt-6 text-right">
                <button className="bg-blue-700 hover:bg-blue-800 text-white py-2 px-6 rounded-md">Generate Report</button>
            </div>
            </section>
            ...
            <div className="bg-slate-800 p-6 rounded-lg shadow-2xl border border-slate-700">
                ...
                <ResponsiveContainer width="100%" height={300}>
                <BarChart data={mockRiskTrend} margin={{ top: 10, right: 30, left: 0, bottom: 0 }}>
                    <CartesianGrid strokeDasharray="3 3" stroke="#475569" />
                    <XAxis dataKey="date" stroke="#94a3b8" />
                    <YAxis stroke="#94a3b8" />
                    <Tooltip
            ...
            <div className="overflow-x-auto">
                ...
                <tbody className="divide-y divide-slate-700">
                    ...
                    <tr key={c.id} className="hover:bg-slate-700/20">
                        ...
                        <span
                            className={`px-2 inline-flex text-xs rounded-full border 
                            ${c.riskLevel === 'High'
            ...
            <p className="text-gray-300 mb-6">Download compliance reports.</p>
            <div className="flex justify-center gap-4">
                <button className="bg-green-700 hover:bg-green-800 text-white py-2 px-6 rounded-md">Export to CSV</button>
                <button className="bg-red-700 hover:bg-red-800 text-white py-2 px-6 rounded-md">Export to PDF</button>
            </div>
            </section>
        </main>
        </div>
